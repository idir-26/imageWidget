...
class imageController extends WidgetController {
	...
	async recherche() {
		...
		let article = new xph().doc(dom).ctx(dom).craft('/html/body/div[5]/div[3]/div[3]/div[2]/div/div[2]/div[2]/div/div/div/div/div[1]/div[2]/div[1]/div[1]/a[1]/img').firstResult; // find interesting things
		this.mvc.view.update(article.getAttributes("/html/body/div[5]/div[3]/div[3]/div[2]/div/div[2]/div[2]/div/div/div/div/div[1]/div[2]/div[1]/div[1]/a[1]/img"));
